...
export default function PlayerLargeControls({
  ...
  return (
    <div className="fixed inset-0 bg-slate-950 flex flex-col items-center justify-center z-50">
      ...
      >
        {metadata && (metadata.title || metadata.artist) && metadata.is_song ? (
          <>
            ...
            <div className="text-white/70 text-xl md:text-2xl mb-4">{metadata.artist || "Unknown Artist"}</div>
          </>
        ) : null}
      ...
      >
        {/* AI Trigger Button - Replaced with AIIntegratedStatus */}
        <div className="scale-125">
          <AIIntegratedStatus variant="full" />
        </div>
